...
@EqualsAndHashCode
public class RnnNetwork implements Serializable {
    @Getter
    ...
    public RnnNetwork(@NonNull RnnLayerTopology topology) throws VectorMatrixException {
    ...
    */
    ...
    public static RnnNetwork load(String path) throws IOException, ClassNotFoundException {
        if (! path.endsWith(".jnn")) {
            throw new IOException("Incorrect filename! File format must be '.jnn'!");
        }
        FileInputStream fileInputStream = new FileInputStream(path);
        ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
        RnnNetwork NN = (RnnNetwork) objectInputStream.readObject();
